...
window.StoreinoApp.$store = {
    ...
    get: async function (module, params) {
     ...
     create: async function (module, params, data) {
        let response = await http.post(`/api/${module}/create`, data, {
          params
        });
        return response.data;
      },
      ...
      update: async function (module, params, data) {
        let response = await http.post(`/api/${module}/update`, data, {
          params
        });
        return response.data;
      },
...
(async () => {
    ...
    let response = await window.StoreinoApp.$store.get("apps", {
     ...
     window.__DATA__ = typeof response.config === 'string' ? JSON.parse(response.config) : response.config;
